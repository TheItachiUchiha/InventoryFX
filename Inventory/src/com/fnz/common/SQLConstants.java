...
public class SQLConstants
{
	...
	public static final String CREATE_INCOMING_STOCK_DETAILS = "CREATE TABLE if not exists INCOMING_STOCK_DETAILS (INVOICE_ID TEXT, ITEM_ID text, QUANTITY INTEGER," +
