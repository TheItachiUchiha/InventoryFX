...
public class SQLConstants
{
	...
	public static final String CREATE_INCOMING_STOCK_DETAILS = "CREATE TABLE if not exists INCOMING_STOCK_DETAILS (INVOICE_ID TEXT, TYPE_ID text, QUANTITY INTEGER," +
			" PRIMARY KEY(INVOICE_ID,TYPE_ID), FOREIGN KEY(TYPE_ID) REFERENCES ITEMS_TYPES_TABLE(TYPE_ID))";
