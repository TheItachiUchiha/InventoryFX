...
public class SQLConstants
{
	...
	public static final String FETCH_INCOMING_DETAILS_BY_DATE = "SELECT ID.INVOICE_ID, I.DATE_OF_DELIVERY, IT.ITEM_ID, IT.ITEM_NAME, CT.TYPE_ID, CT.TYPE, ID.QUANTITY FROM INCOMING_STOCK I,"+
					" INCOMING_STOCK_DETAILS ID, ITEMS_TABLE IT, CATEGORY_TYPES CT WHERE I.INVOICE_ID = ID.INVOICE_ID AND IT.ITEM_ID = ID.ITEM_ID AND CT.TYPE_ID = ID.TYPE_ID AND I.DATE_OF_DELIVERY >= ? and I.DATE_OF_DELIVERY <= ?";
	...
	public static final String DELETE_TRANSACTION_INCOMING_STOCK_DETAILS_2 = "' AND ITEM_ID='";
	public static final String DELETE_TRANSACTION_INCOMING_STOCK_DETAILS_3 = "' AND TYPE_ID='";
	public static final String DELETE_TRANSACTION_INCOMING_STOCK_DETAILS_4 = "'";
