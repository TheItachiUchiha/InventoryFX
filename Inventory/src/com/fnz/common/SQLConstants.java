...
public class SQLConstants
{
	...
	public static final String INDEX_ITEM_TABLE_UNIQUE_CASEINSENSITIVE = "CREATE UNIQUE INDEX IF NOT EXISTS uidxItemName ON ITEMS_TABLE (ITEM_NAME COLLATE NOCASE)";
	...
	public static final String INDEX_CATEGORY_TYPES_UNIQUE_CASEINSENSITIVE = "CREATE UNIQUE INDEX IF NOT EXISTS uidxTypeName ON CATEGORY_TYPES (TYPE COLLATE NOCASE)";
	...
	public static final String UPDATE_OUTGOING_STOCK_DETAILS_1 = "UPDATE OUTGOING_STOCK_DETAILS SET QUANTITY = QUANTITY + ";
	public static final String UPDATE_OUTGOING_STOCK_DETAILS_2 = " WHERE ITEM_ID='";
	public static final String UPDATE_OUTGOING_STOCK_DETAILS_3 = "' AND TYPE_ID='";
	public static final String UPDATE_OUTGOING_STOCK_DETAILS_4 = "' AND DATE_OF_DELIVERY='";
	public static final String UPDATE_OUTGOING_STOCK_DETAILS_5 = "';";
	...
	public static final String FETCH_OUTGOING_BY_DATE = "SELECT O.ITEM_ID, O.TYPE_ID FROM OUTGOING_STOCK_DETAILS O WHERE O.DATE_OF_DELIVERY=?";
