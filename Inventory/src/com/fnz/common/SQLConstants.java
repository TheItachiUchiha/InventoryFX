...
public class SQLConstants
{
	...
	public static final String CREATE_ITEM_TABLE = "CREATE TABLE if not exists ITEMS_TABLE (ITEM_ID text UNIQUE NOT NULL,ITEM_NAME text,CATEGORY_ID TEXT,QUANTITY INTEGER,"+
			"Q_D_PRICE INTEGER, Q_MRP INTEGER, Q_H_PRICE INTEGER, P_D_PRICE INTEGER, P_MRP INTEGER, P_H_PRICE INTEGER,N_D_PRICE INTEGER, N_MRP INTEGER, N_H_PRICE INTEGER"+
